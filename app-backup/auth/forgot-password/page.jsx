        ...
        <Card className="w-full max-w-md">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Si el email <strong>{email}</strong> está registrado en nuestro sistema, recibirás instrucciones para resetear tu contraseña.
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Revisa tu bandeja de entrada</strong> y también la carpeta de spam. El enlace de recuperación expira en 1 hora.
              </p>
            </div>
            <div className="pt-4">
              <Link
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              <strong>¿Problemas para acceder?</strong> Asegúrate de usar el mismo email con el que te registraste. Si sigues teniendo problemas, contacta a soporte.
            </p>
          </div>
        </div>
      </Card>
