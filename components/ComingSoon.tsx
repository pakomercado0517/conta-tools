        ...
        <Card className="backdrop-blur-sm bg-white/70 dark:bg-gray-800/70 border-0 shadow-2xl">
          <div className="text-center py-12">
            ...
            {showNotifyMe && (
              <div className="mb-6">
                <button 
                  className={`inline-flex items-center px-6 py-3 bg-gradient-to-r ${config.gradient} text-white rounded-xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800`}
                  type="button"
