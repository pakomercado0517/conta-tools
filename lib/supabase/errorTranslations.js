 ...
 * @returns {string} - Mensaje de error traducido y contextualizado
 */
export function translateSupabaseError(errorMessage, errorCode = null) {
 ...
 * @param {Object} error - Error object de Supabase
 * @param {string} context - Contexto de la operación (login, signup, recovery, etc.)
 * @returns {string} - Mensaje de error contextualizado
 */
export function getContextualError(error, context = '') {
