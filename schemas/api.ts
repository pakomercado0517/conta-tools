...
export type GeneratorConceptRequest = z.infer<typeof GeneratorConceptRequestSchema>;
...
export type QuotationCreatedResponse = z.infer<typeof QuotationCreatedResponseSchema>;
...
export const FileUploadRequestSchema = z.object({
  ...
  maxSize: z.number().max(10 * 1024 * 1024, 'Archivo muy grande (máx 10MB)').optional(),
});
...
export const PaginationParamsSchema = z.object({
  ...
  limit: z.number().int().min(1, 'El límite debe ser mayor a 0').max(100, 'Máximo 100 items por página').default(10),
